...
set_property -dict {PACKAGE_PIN V10 IOSTANDARD LVCMOS33} [get_ports {sw_mode}]
...
set_property -dict {PACKAGE_PIN V11 IOSTANDARD LVCMOS33} [get_ports {led_mode}]

## Color LEDs
set_property -dict {PACKAGE_PIN N15 IOSTANDARD LVCMOS33} [get_ports rgb_led16[2]]; # R
set_property -dict {PACKAGE_PIN M16 IOSTANDARD LVCMOS33} [get_ports rgb_led16[1]]; # G
set_property -dict {PACKAGE_PIN R12 IOSTANDARD LVCMOS33} [get_ports rgb_led16[0]]; # B
...
## Pmod Header JA
set_property -dict {PACKAGE_PIN C17 IOSTANDARD LVCMOS33} [get_ports {uart_tx_alt}];
